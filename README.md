...
Beware: Training on CPU is not recommended to children and pregnant women. We'll do for the sake of simplicity.
...
It would be good to delete all runs of small dataset from "finger-counting" experiment, to not compete for best model
chooser.
